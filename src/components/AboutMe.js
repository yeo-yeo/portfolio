  ...
  return (
    <main>
      ...
      <p className="bio">
        ...
        business processes and technology are integrated, and how in traditional
        industries there is room for improvement.
      </p>
      <p className="bio">
        I have a First className degree from the University of Edinburgh in
        English Literature and Latin. While it might not be the 100% traditional
        background for a developer, I think the literary and linguistic
        analsysis, and rigorous application of grammar and syntax in Latin are
        actually a perfect preparation for programming.
      </p>
      <p className="bio">
